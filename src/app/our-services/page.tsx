...
const Coffee = () => {
  const coffeeData = [
    ...
    { id: 4, name: "Chock full o'Nuts", price: 8.48, description: 'Coffee beans', image: "/images/coffeecup.jpeg" },
    { id: 5, name: "Cuppuchino", price: 36.00, description: 'Coffee-bean-pacific-park', image: "/images/cream.jpeg" },
    { id: 6, name: "Kahwa Coffee", price: 43.01, description: 'Kahwa Coffee Roasters', image: "/images/kahwa.jpeg" },
    { id: 7, name: "Cuppuchino", price: 36.00, description: 'Coffee-bean-pacific-park', image: "/images/imagesC.jpeg" },
    { id: 8, name: "Coldd Ice Coffee", price: 43.01, description: 'Kahwa Coffee Roasters', image: "/images/coffeebrandpack.jpg" },
    { id: 9, name: "Cuppuchino", price: 36.00, description: 'Coffee-bean-pacific-park', image: "/images/thbg.jpeg" },
